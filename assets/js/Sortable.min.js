...
function getChildContainingRectFromElement(container, options, ghostEl) {
  ...
  Array.from(container.children).forEach(function (child) {
    let _rect$left, _rect$top, _rect$right, _rect$bottom;
    if (
...
const PluginManager = {
  ...
  initializePlugins: function initializePlugins(
    ...
    for (const option in sortable.options) {
      ...
      const modified = this.modifyOption(
        sortable,
        option,
...
function dispatchEvent(_ref) {
  ...
  const allEventProperties = _objectSpread2(
...
const nearestEmptyInsertDetectEvent = function nearestEmptyInsertDetectEvent(
  evt
) {
  if (dragEl) {
      ...
      if (
        ...
        if (
          ...
          pointerElemChangedInterval = setInterval(function () {
            const newElem = getParentAutoScrollElement(
      ...
      if (vx != 0 || vy != 0) {
        ...
        autoScrolls[layersOut].pid = setInterval(
          function () {
            ...
            const scrollOffsetY = autoScrolls[this.layer].vy
              ? autoScrolls[this.layer].vy * speed
              : 0;
            const scrollOffsetX = autoScrolls[this.layer].vx
            ...
            if (~lastIndex && ~currentIndex && lastIndex !== currentIndex) {
              (function () {
                ...
                for (; i < n; i++) {
                  ...
                  if (
                    !closest(children[i], options.draggable, parentEl, false)
                  ) {
                    continue;
                  }
